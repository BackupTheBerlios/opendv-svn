...
void CDStarRepeaterTXThread::start()
{
	Create();
...
void CDStarRepeaterTXThread::wait()
{
	Wait();
}

void CDStarRepeaterTXThread::setReader(CWAVFileReader* reader)
{
}

void CDStarRepeaterTXThread::setCallsign(const wxString& callsign, const wxString& gateway, DSTAR_MODE mode, ACK_TYPE ack, bool restriction, bool rpt1Validation)
{
...
void CDStarRepeaterTXThread::setSoundCard(CSoundCardReaderWriter* soundcard, wxFloat32 rxLevel, wxFloat32 txLevel, SQUELCH_MODE squelchMode, wxFloat32 squelchLevel, bool rxInvert, bool txInvert)
{
...
void CDStarRepeaterTXThread::setTimes(unsigned int timeout, unsigned int ackTime, unsigned int hangTime)
{
...
void CDStarRepeaterTXThread::setController(CExternalController* controller, int pttDelay)
{
...
void CDStarRepeaterTXThread::setActiveHang(unsigned int time)
{
...
void CDStarRepeaterTXThread::setRXLevel(wxFloat32 level)
{
}

void CDStarRepeaterTXThread::setTXLevel(wxFloat32 level)
{
}

void CDStarRepeaterTXThread::setSquelchLevel(wxFloat32 level)
{
}
...
void CDStarRepeaterTXThread::transmitNetwork()
{
...
void CDStarRepeaterTXThread::transmit()
{
	// Switch off the transmitter?
	if (m_tx) {
		// If no hang time, switch off the TX immediately
...
void CDStarRepeaterTXThread::transmitBits(const bool* bits, unsigned int length)
{
	wxASSERT(bits != NULL);
...
void CDStarRepeaterTXThread::callback(const wxFloat32* input, wxFloat32* output, unsigned int nSamples, int id)
{
...
void CDStarRepeaterTXThread::blankDTMF(unsigned char* data)
{
	wxASSERT(data != NULL);
