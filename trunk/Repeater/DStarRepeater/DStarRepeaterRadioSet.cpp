...
#include "DStarRepeaterRadioSet.h"
...
BEGIN_EVENT_TABLE(CDStarRepeaterRadioSet, wxPanel)
	EVT_COMMAND_SCROLL_THUMBTRACK(Slider_RX,      CDStarRepeaterRadioSet::onRXLevel)
	EVT_COMMAND_SCROLL_THUMBTRACK(Slider_TX,      CDStarRepeaterRadioSet::onTXLevel)
	EVT_COMMAND_SCROLL_THUMBTRACK(Slider_Squelch, CDStarRepeaterRadioSet::onSquelchLevel)
END_EVENT_TABLE()
...
CDStarRepeaterRadioSet::CDStarRepeaterRadioSet(wxWindow* parent, int id, const wxString& title, const wxString& readDevice, const wxString& writeDevice, wxFloat32 rxLevel, wxFloat32 txLevel, SQUELCH_MODE squelchMode, wxFloat32 squelchLevel, bool rxInvert, bool txInvert) :
wxPanel(parent, id),
m_title(title),
m_readDevice(NULL),
m_writeDevice(NULL),
...
CDStarRepeaterRadioSet::~CDStarRepeaterRadioSet()
{
}

bool CDStarRepeaterRadioSet::Validate()
{
...
wxString CDStarRepeaterRadioSet::getReadDevice() const
{
...
wxString CDStarRepeaterRadioSet::getWriteDevice() const
{
...
wxFloat32 CDStarRepeaterRadioSet::getRXLevel() const
{
...
wxFloat32 CDStarRepeaterRadioSet::getTXLevel() const
{
...
SQUELCH_MODE CDStarRepeaterRadioSet::getSquelchMode() const
{
...
wxFloat32 CDStarRepeaterRadioSet::getSquelchLevel() const
{
...
bool CDStarRepeaterRadioSet::getRXInvert() const
{
...
bool CDStarRepeaterRadioSet::getTXInvert() const
{
...
void CDStarRepeaterRadioSet::onRXLevel(wxScrollEvent &event)
{
...
void CDStarRepeaterRadioSet::onTXLevel(wxScrollEvent &event)
{
	int n = event.GetPosition();
...
void CDStarRepeaterRadioSet::onSquelchLevel(wxScrollEvent &event)
{
	int n = event.GetPosition();
