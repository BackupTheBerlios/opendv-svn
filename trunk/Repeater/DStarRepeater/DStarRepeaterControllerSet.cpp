...
CDStarRepeaterControllerSet::CDStarRepeaterControllerSet(wxWindow* parent, int id, const wxString& title, const wxString& type, unsigned int config, int pttDelay, bool pttInvert) :
wxPanel(parent, id),
m_title(title),
m_type(NULL),
m_config(NULL),
...
unsigned int CDStarRepeaterControllerSet::getConfig() const
{
...
int CDStarRepeaterControllerSet::getPTTDelay() const
{
...
bool CDStarRepeaterControllerSet::getPTTInvert() const
{
