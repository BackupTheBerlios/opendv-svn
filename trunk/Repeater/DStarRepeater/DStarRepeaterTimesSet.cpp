...
CDStarRepeaterTimesSet::CDStarRepeaterTimesSet(wxWindow* parent, int id, const wxString& title, unsigned int timeout, unsigned int ackTime, unsigned int hangTime) :
wxPanel(parent, id),
m_title(title),
m_timeout(NULL),
m_ackTime(NULL),
...
unsigned int CDStarRepeaterTimesSet::getHangTime() const
{
