...
unsigned int CDStarRepeaterStatusData::getActiveTimer() const
{
	return m_activeTimer;
}

unsigned int CDStarRepeaterStatusData::getActiveExpiry() const
{
...
float CDStarRepeaterStatusData::getNoise() const
{
	return m_noise;
}
