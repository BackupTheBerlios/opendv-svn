...
#ifndef	DStarRepeaterModemDVRPTRV1Controller_H
#define	DStarRepeaterModemDVRPTRV1Controller_H
...
class CDStarRepeaterModemDVRPTRV1Controller : public wxThread, public IDStarRepeaterModem {
public:
	CDStarRepeaterModemDVRPTRV1Controller(const wxString& port, const wxString& path, bool rxInvert, bool txInvert, bool channel, unsigned int modLevel, unsigned int txDelay);
	virtual ~CDStarRepeaterModemDVRPTRV1Controller();
