...
void CDStarRepeaterConfig::getCallsign(wxString& callsign, wxString& gateway, DSTAR_MODE& mode, ACK_TYPE& ack, bool& restriction, bool& rpt1Validation) const
{
	callsign       = m_callsign;
	gateway        = m_gateway;
	mode           = m_mode;
...
void CDStarRepeaterConfig::setCallsign(const wxString& callsign, const wxString& gateway, DSTAR_MODE mode, ACK_TYPE ack, bool restriction, bool rpt1Validation)
{
	m_callsign       = callsign;
	m_gateway        = gateway;
	m_mode           = mode;
...
void CDStarRepeaterConfig::getRadio(wxString& readDevice, wxString& writeDevice, wxFloat32& rxLevel, wxFloat32& txLevel, SQUELCH_MODE& squelchMode, wxFloat32& squelchLevel, bool& rxInvert, bool& txInvert) const
{
...
void CDStarRepeaterConfig::setRadio(const wxString& readDevice, const wxString& writeDevice, wxFloat32 rxLevel, wxFloat32 txLevel, SQUELCH_MODE squelchMode, wxFloat32 squelchLevel, bool rxInvert, bool txInvert)
{
...
void CDStarRepeaterConfig::getController(wxString& type, unsigned int& config, int& pttDelay, bool& pttInvert) const
{
...
void CDStarRepeaterConfig::setController(const wxString& type, unsigned int config, int pttDelay, bool pttInvert)
{
...
void CDStarRepeaterConfig::getTimes(unsigned int& timeout, unsigned int& ackTime, unsigned int& hangTime) const
{
	timeout  = m_timeout;
	ackTime  = m_ackTime;
	hangTime = m_hangTime;
...
void CDStarRepeaterConfig::setTimes(unsigned int timeout, unsigned int ackTime, unsigned int hangTime)
{
	m_timeout  = timeout;
	m_ackTime  = ackTime;
	m_hangTime = hangTime;
...
void CDStarRepeaterConfig::getActiveHang(unsigned int& time) const
{
	time = m_activeHangTime;
}

void CDStarRepeaterConfig::setActiveHang(unsigned int time)
{
