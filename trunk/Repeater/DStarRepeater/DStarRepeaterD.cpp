...
int main(int argc, char** argv)
{
	...
	CDStarRepeaterD repeater(nolog, logDir, confDir, name);
...
CDStarRepeaterD::CDStarRepeaterD(bool nolog, const wxString& logDir, const wxString& confDir, const wxString& name) :
m_name(name),
m_nolog(nolog),
m_logDir(logDir),
m_confDir(confDir),
