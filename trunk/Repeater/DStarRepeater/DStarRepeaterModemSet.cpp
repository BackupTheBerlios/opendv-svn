...
BEGIN_EVENT_TABLE(CDStarRepeaterModemSet, wxPanel)
	EVT_CHOICE(CHOICE_VERSION, CDStarRepeaterModemSet::onVersion)
	EVT_CHOICE(CHOICE_TYPE,    CDStarRepeaterModemSet::onConnectionType)
END_EVENT_TABLE()


CDStarRepeaterModemSet::CDStarRepeaterModemSet(wxWindow* parent, int id, const wxString& title, DVRPTR_VERSION version, CONNECTION_TYPE connectionType, const wxString& usbPort, const wxString& address, unsigned int port, bool rxInvert, bool txInvert, bool channel, unsigned int modLevel, unsigned int txDelay) :
wxPanel(parent, id),
m_title(title),
m_version(NULL),
...
DVRPTR_VERSION CDStarRepeaterModemSet::getVersion() const
{
...
CONNECTION_TYPE CDStarRepeaterModemSet::getConnectionType() const
{
...
wxString CDStarRepeaterModemSet::getUSBPort() const
{
...
wxString CDStarRepeaterModemSet::getAddress() const
{
	return m_address->GetValue();
}

unsigned int CDStarRepeaterModemSet::getPort() const
{
	unsigned long n;
...
bool CDStarRepeaterModemSet::getRXInvert() const
{
...
bool CDStarRepeaterModemSet::getTXInvert() const
{
...
bool CDStarRepeaterModemSet::getChannel() const
{
...
unsigned int CDStarRepeaterModemSet::getModLevel() const
{
	return (unsigned int)m_modLevel->GetValue();
}

unsigned int CDStarRepeaterModemSet::getTXDelay() const
{
	return (unsigned int)m_txDelay->GetValue();
}

void CDStarRepeaterModemSet::onVersion(wxCommandEvent &event)
{
...
void CDStarRepeaterModemSet::onConnectionType(wxCommandEvent &event)
{
	int n = event.GetSelection();
