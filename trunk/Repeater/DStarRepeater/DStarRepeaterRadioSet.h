...
#ifndef	DStarRepeaterRadioSet_H
#define	DStarRepeaterRadioSet_H
...
class CDStarRepeaterRadioSet : public wxPanel {
public:
	CDStarRepeaterRadioSet(wxWindow* parent, int id, const wxString& title, const wxString& readDevice, const wxString& writeDevice, wxFloat32 rxLevel, wxFloat32 txLevel, SQUELCH_MODE squelchMode, wxFloat32 squelchLevel, bool rxInvert, bool txInvert);
	virtual ~CDStarRepeaterRadioSet();
