...
CDStarRepeaterConfigRaspberrySet::CDStarRepeaterConfigRaspberrySet(wxWindow* parent, int id, bool rxInvert, bool txInvert, unsigned int txDelay) :
...
CDStarRepeaterConfigRaspberrySet::~CDStarRepeaterConfigRaspberrySet()
{
}

bool CDStarRepeaterConfigRaspberrySet::Validate()
{
...
bool CDStarRepeaterConfigRaspberrySet::getRXInvert() const
{
...
bool CDStarRepeaterConfigRaspberrySet::getTXInvert() const
{
...
unsigned int CDStarRepeaterConfigRaspberrySet::getTXDelay() const
{
