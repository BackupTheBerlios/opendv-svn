...
CDVAPNodeDVAPSet::~CDVAPNodeDVAPSet()
{
}

bool CDVAPNodeDVAPSet::Validate()
{
...
wxString CDVAPNodeDVAPSet::getPort() const
{
	return m_port->GetStringSelection();
}

unsigned int CDVAPNodeDVAPSet::getFrequency() const
{
...
int CDVAPNodeDVAPSet::getPower() const
{
