...
#ifndef	DStarModemDVRPTRV2Controller_H
#define	DStarModemDVRPTRV2Controller_H
...
class CDStarModemDVRPTRV2Controller : public wxThread, public IDStarModem {
public:
	CDStarModemDVRPTRV2Controller(const wxString& port, const wxString& path, bool txInvert, unsigned int modLevel, bool duplex, const wxString& callsign);
	CDStarModemDVRPTRV2Controller(const wxString& address, unsigned int port, bool txInvert, unsigned int modLevel, bool duplex, const wxString& callsign);
	virtual ~CDStarModemDVRPTRV2Controller();
