...
wxArrayString CDStarModemDVRPTRV2Controller::getDevices()
{
#if defined(__WINDOWS__)
...
CDStarModemDVRPTRV2Controller::CDStarModemDVRPTRV2Controller(const wxString& port, const wxString& path, bool txInvert, unsigned int modLevel, bool duplex, const wxString& callsign) :
...
CDStarModemDVRPTRV2Controller::CDStarModemDVRPTRV2Controller(const wxString& address, unsigned int port, bool txInvert, unsigned int modLevel, bool duplex, const wxString& callsign) :
wxThread(wxTHREAD_JOINABLE),
...
CDStarModemDVRPTRV2Controller::~CDStarModemDVRPTRV2Controller()
{
	delete m_usb;
	delete m_network;
...
bool CDStarModemDVRPTRV2Controller::open()
{
	findPort();
...
void* CDStarModemDVRPTRV2Controller::Entry()
{
...
// Every 500ms
void CDStarModemDVRPTRV2Controller::heartbeat()
{
}

bool CDStarModemDVRPTRV2Controller::setTX(bool on)
{
	return true;
}

DSMT_TYPE CDStarModemDVRPTRV2Controller::read()
{
	m_readLength = 0U;
...
CHeaderData* CDStarModemDVRPTRV2Controller::readHeader()
{
...
unsigned int CDStarModemDVRPTRV2Controller::readData(unsigned char* data, unsigned int length, bool& end)
{
	end = false;
...
bool CDStarModemDVRPTRV2Controller::writeHeader(const CHeaderData& header)
{
...
bool CDStarModemDVRPTRV2Controller::writeData(const unsigned char* data, unsigned int length, bool end)
{
...
bool CDStarModemDVRPTRV2Controller::getTX()
{
	return m_tx;
}

unsigned int CDStarModemDVRPTRV2Controller::getSpace()
{
	return m_space;
}

void CDStarModemDVRPTRV2Controller::close()
{
	m_stopped = true;
...
bool CDStarModemDVRPTRV2Controller::readSerial()
{
	unsigned char buffer[105U];
...
bool CDStarModemDVRPTRV2Controller::readSpace()
{
...
bool CDStarModemDVRPTRV2Controller::setConfig()
{
	unsigned char buffer[105U];
...
RESP_TYPE_V2 CDStarModemDVRPTRV2Controller::getResponse(unsigned char *buffer, unsigned int& length)
{
...
wxString CDStarModemDVRPTRV2Controller::getPath() const
{
	return m_usbPath;
}

bool CDStarModemDVRPTRV2Controller::findPort()
{
...
bool CDStarModemDVRPTRV2Controller::findPath()
{
	if (m_connection != CT_USB)
		return true;
...
bool CDStarModemDVRPTRV2Controller::findModem()
{
	closeModem();
...
bool CDStarModemDVRPTRV2Controller::openModem()
{
	bool ret = false;
...
int CDStarModemDVRPTRV2Controller::readModem(unsigned char* buffer, unsigned int length)
{
	switch (m_connection) {
		case CT_USB:
...
bool CDStarModemDVRPTRV2Controller::writeModem(const unsigned char* buffer, unsigned int length)
{
	switch (m_connection) {
		case CT_USB:
...
void CDStarModemDVRPTRV2Controller::closeModem()
{
	switch (m_connection) {
		case CT_USB:
			return m_usb->close();
