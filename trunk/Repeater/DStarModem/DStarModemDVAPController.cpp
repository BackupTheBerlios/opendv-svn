...
CDStarModemDVAPController::CDStarModemDVAPController(const wxString& port, unsigned int frequency, int power, int squelch) :
...
CDStarModemDVAPController::~CDStarModemDVAPController()
{
	delete[] m_buffer;
	delete[] m_readBuffer;
}

bool CDStarModemDVAPController::open()
{
...
void* CDStarModemDVAPController::Entry()
{
...
bool CDStarModemDVAPController::setTX(bool on)
{
	return true;
}

DSMT_TYPE CDStarModemDVAPController::read()
{
	m_readLength = 0U;
...
CHeaderData* CDStarModemDVAPController::readHeader()
{
...
unsigned int CDStarModemDVAPController::readData(unsigned char* data, unsigned int length, bool& end)
{
	end = false;
...
bool CDStarModemDVAPController::writeHeader(const CHeaderData& header)
{
	m_accepted = false;
...
bool CDStarModemDVAPController::writeData(const unsigned char* data, unsigned int length, bool end)
{
	if (!m_accepted)
		return false;
...
void CDStarModemDVAPController::close()
{
	m_stopped = true;
...
unsigned int CDStarModemDVAPController::getSpace()
{
	return m_space;
}

bool CDStarModemDVAPController::getTX()
{
	return m_tx;
}

bool CDStarModemDVAPController::getName()
{
...
bool CDStarModemDVAPController::getFirmware()
{
	unsigned int count = 0U;
	unsigned int length;
	RESP_TYPE resp;
...
bool CDStarModemDVAPController::getSerial()
{
	unsigned int count = 0U;
	unsigned int length;
	RESP_TYPE resp;
...
bool CDStarModemDVAPController::start()
{
	unsigned int count = 0U;
	unsigned int length;
	RESP_TYPE resp;
...
bool CDStarModemDVAPController::stop()
{
	unsigned int count = 0U;
	unsigned int length;
	RESP_TYPE resp;
...
bool CDStarModemDVAPController::setModulation()
{
	unsigned int count = 0U;
	unsigned int length;
	RESP_TYPE resp;
...
bool CDStarModemDVAPController::setMode()
{
	unsigned int count = 0U;
	unsigned int length;
	RESP_TYPE resp;
...
bool CDStarModemDVAPController::setSquelch()
{
	unsigned int count = 0U;
	unsigned int length;
	RESP_TYPE resp;
...
bool CDStarModemDVAPController::setPower()
{
	unsigned int count = 0U;
	unsigned int length;
	RESP_TYPE resp;
...
bool CDStarModemDVAPController::setFrequency()
{
	unsigned int count = 0U;
	unsigned int length;
	RESP_TYPE resp;
...
RESP_TYPE CDStarModemDVAPController::getResponse(unsigned char *buffer, unsigned int& length)
{
...
void CDStarModemDVAPController::resync()
{
