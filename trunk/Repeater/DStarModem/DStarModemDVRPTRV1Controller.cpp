...
wxArrayString CDStarModemDVRPTRV1Controller::getDevices()
{
#if defined(__WINDOWS__)
...
CDStarModemDVRPTRV1Controller::CDStarModemDVRPTRV1Controller(const wxString& port, const wxString& path, bool rxInvert, bool txInvert, bool channel, unsigned int modLevel, unsigned int txDelay) :
...
CDStarModemDVRPTRV1Controller::~CDStarModemDVRPTRV1Controller()
{
	delete[] m_buffer;
	delete[] m_readBuffer;
}

bool CDStarModemDVRPTRV1Controller::open()
{
	findPort();
...
void* CDStarModemDVRPTRV1Controller::Entry()
{
...
// Every 500ms
void CDStarModemDVRPTRV1Controller::heartbeat()
{
}

bool CDStarModemDVRPTRV1Controller::setTX(bool on)
{
	return true;
}

DSMT_TYPE CDStarModemDVRPTRV1Controller::read()
{
	m_readLength = 0U;
...
CHeaderData* CDStarModemDVRPTRV1Controller::readHeader()
{
...
unsigned int CDStarModemDVRPTRV1Controller::readData(unsigned char* data, unsigned int length, bool& end)
{
	end = false;
...
bool CDStarModemDVRPTRV1Controller::writeHeader(const CHeaderData& header)
{
	if (!m_txEnabled)
		return false;
...
bool CDStarModemDVRPTRV1Controller::writeData(const unsigned char* data, unsigned int length, bool end)
{
	if (!m_txEnabled)
		return false;
...
bool CDStarModemDVRPTRV1Controller::getTX()
{
	return m_tx;
}

unsigned int CDStarModemDVRPTRV1Controller::getSpace()
{
	return m_space;
}

void CDStarModemDVRPTRV1Controller::close()
{
	m_stopped = true;
...
bool CDStarModemDVRPTRV1Controller::readVersion()
{
...
bool CDStarModemDVRPTRV1Controller::readStatus()
{
	unsigned char buffer[10U];
...
bool CDStarModemDVRPTRV1Controller::setConfig()
{
...
bool CDStarModemDVRPTRV1Controller::setEnabled(bool enable)
{
	unsigned char buffer[10U];
...
RESP_TYPE_V1 CDStarModemDVRPTRV1Controller::getResponse(unsigned char *buffer, unsigned int& length)
{
...
wxString CDStarModemDVRPTRV1Controller::getPath() const
{
	return m_path;
}

bool CDStarModemDVRPTRV1Controller::findPort()
{
	if (m_path.IsEmpty())
		return false;
...
bool CDStarModemDVRPTRV1Controller::findPath()
{
#if defined(__WINDOWS__)
#ifdef notdef
	GUID guids[5U];
...
bool CDStarModemDVRPTRV1Controller::findModem()
{
	m_serial.close();
...
bool CDStarModemDVRPTRV1Controller::openModem()
{
