...
#ifndef	DStarModemDVRPTRV1Controller_H
#define	DStarModemDVRPTRV1Controller_H
...
class CDStarModemDVRPTRV1Controller : public wxThread, public IDStarModem {
public:
	CDStarModemDVRPTRV1Controller(const wxString& port, const wxString& path, bool rxInvert, bool txInvert, bool channel, unsigned int modLevel, unsigned int txDelay);
	virtual ~CDStarModemDVRPTRV1Controller();
