...
#ifndef	DStarModemDVAPController_H
#define	DStarModemDVAPController_H
...
class CDStarModemDVAPController : public wxThread, public IDStarModem {
public:
	CDStarModemDVAPController(const wxString& port, unsigned int frequency, int power, int squelch);
	virtual ~CDStarModemDVAPController();
