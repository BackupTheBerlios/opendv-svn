...
BEGIN_EVENT_TABLE(CDVRPTRRepeaterCallsignSet, wxPanel)
	EVT_CHOICE(CHOICE_MODE, CDVRPTRRepeaterCallsignSet::onMode)
END_EVENT_TABLE()


CDVRPTRRepeaterCallsignSet::CDVRPTRRepeaterCallsignSet(wxWindow* parent, int id, const wxString& title, const wxString& callsign, const wxString& gateway, DSTAR_MODE mode, ACK_TYPE ack, bool restriction, bool rpt1Validation, bool dtmfBlanking) :
wxPanel(parent, id),
m_title(title),
m_callsign(NULL),
m_gateway(NULL),
...
CDVRPTRRepeaterCallsignSet::~CDVRPTRRepeaterCallsignSet()
{
}

bool CDVRPTRRepeaterCallsignSet::Validate()
{
...
wxString CDVRPTRRepeaterCallsignSet::getCallsign() const
{
...
wxString CDVRPTRRepeaterCallsignSet::getGateway() const
{
...
DSTAR_MODE CDVRPTRRepeaterCallsignSet::getMode() const
{
...
ACK_TYPE CDVRPTRRepeaterCallsignSet::getAck() const
{
...
bool CDVRPTRRepeaterCallsignSet::getRestriction() const
{
...
void CDVRPTRRepeaterCallsignSet::onMode(wxCommandEvent &event)
{
...
bool CDVRPTRRepeaterCallsignSet::getRPT1Validation() const
{
...
bool CDVRPTRRepeaterCallsignSet::getDTMFBlanking() const
{
