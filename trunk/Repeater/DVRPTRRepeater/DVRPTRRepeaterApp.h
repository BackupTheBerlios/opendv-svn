...
class CDVRPTRRepeaterApp : public wxApp {

public:
	CDVRPTRRepeaterApp();
	virtual ~CDVRPTRRepeaterApp();
	...
	virtual CDVRPTRRepeaterStatusData* getStatus() const;
	...
	virtual void setModem(DVRPTR_VERSION version, const wxString& port, bool rxInvert, bool txInvert, bool channel, unsigned int modLevel, unsigned int txDelay);
...
DECLARE_APP(CDVRPTRRepeaterApp)
