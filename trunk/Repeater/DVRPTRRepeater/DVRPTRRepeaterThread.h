...
#ifndef	DVRPTRRepeaterThread_H
#define	DVRPTRRepeaterThread_H
...
class IDVRPTRRepeaterThread {
public:
	virtual ~IDVRPTRRepeaterThread() {}
	...
	virtual CDVRPTRRepeaterStatusData* getStatus() = 0;
