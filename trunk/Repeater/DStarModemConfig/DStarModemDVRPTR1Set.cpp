...
CDStarModemDVRPTR1Set::CDStarModemDVRPTR1Set(wxWindow* parent, int id, const wxString& port, bool rxInvert, bool txInvert, bool channel, unsigned int modLevel, unsigned int txDelay) :
...
CDStarModemDVRPTR1Set::~CDStarModemDVRPTR1Set()
{
}

bool CDStarModemDVRPTR1Set::Validate()
{
...
wxString CDStarModemDVRPTR1Set::getPort() const
{
...
bool CDStarModemDVRPTR1Set::getRXInvert() const
{
...
bool CDStarModemDVRPTR1Set::getTXInvert() const
{
...
bool CDStarModemDVRPTR1Set::getChannel() const
{
...
unsigned int CDStarModemDVRPTR1Set::getModLevel() const
{
	return (unsigned int)m_modLevel->GetValue();
}

unsigned int CDStarModemDVRPTR1Set::getTXDelay() const
{
