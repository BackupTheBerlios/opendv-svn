...
#ifndef	DStarModemDVRPTR2Set_H
#define	DStarModemDVRPTR2Set_H
...
class CDStarModemDVRPTR2Set : public wxDialog {
public:
	CDStarModemDVRPTR2Set(wxWindow* parent, int id, CONNECTION_TYPE connectionType, const wxString& usbPort, const wxString& address, unsigned int port, bool txInvert, unsigned int modLevel);
	virtual ~CDStarModemDVRPTR2Set();
