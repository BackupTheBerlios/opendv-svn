...
CDStarModemGMSKSet::CDStarModemGMSKSet(wxWindow* parent, int id, USB_INTERFACE type, unsigned int address) :
...
CDStarModemGMSKSet::~CDStarModemGMSKSet()
{
}

bool CDStarModemGMSKSet::Validate()
{
#if defined(WIN32)
...
USB_INTERFACE CDStarModemGMSKSet::getType() const
{
#if defined(WIN32)
...
unsigned int CDStarModemGMSKSet::getAddress() const
{
