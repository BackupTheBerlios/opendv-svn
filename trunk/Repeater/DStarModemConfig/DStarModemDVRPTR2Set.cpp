...
BEGIN_EVENT_TABLE(CDStarModemDVRPTR2Set, wxDialog)
	EVT_CHOICE(CHOICE_TYPE,    CDStarModemDVRPTR2Set::onConnectionType)
END_EVENT_TABLE()


CDStarModemDVRPTR2Set::CDStarModemDVRPTR2Set(wxWindow* parent, int id, CONNECTION_TYPE connectionType, const wxString& usbPort, const wxString& address, unsigned int port, bool txInvert, unsigned int modLevel) :
...
m_modLevel(NULL)
{
	...
	wxArrayString ports = CDVRPTRControllerV2::getDevices();
...
CDStarModemDVRPTR2Set::~CDStarModemDVRPTR2Set()
{
}

bool CDStarModemDVRPTR2Set::Validate()
{
...
CONNECTION_TYPE CDStarModemDVRPTR2Set::getConnectionType() const
{
...
wxString CDStarModemDVRPTR2Set::getUSBPort() const
{
...
wxString CDStarModemDVRPTR2Set::getAddress() const
{
	return m_address->GetValue();
}

unsigned int CDStarModemDVRPTR2Set::getPort() const
{
	unsigned long n;
...
bool CDStarModemDVRPTR2Set::getTXInvert() const
{
...
unsigned int CDStarModemDVRPTR2Set::getModLevel() const
{
	return (unsigned int)m_modLevel->GetValue();
}

void CDStarModemDVRPTR2Set::onConnectionType(wxCommandEvent &event)
{
