...
CDStarModemDVAPSet::CDStarModemDVAPSet(wxWindow* parent, int id, const wxString& port, unsigned int frequency, int power, int squelch) :
...
CDStarModemDVAPSet::~CDStarModemDVAPSet()
{
}

bool CDStarModemDVAPSet::Validate()
{
...
wxString CDStarModemDVAPSet::getPort() const
{
	return m_port->GetStringSelection();
}

unsigned int CDStarModemDVAPSet::getFrequency() const
{
...
int CDStarModemDVAPSet::getPower() const
{
...
int CDStarModemDVAPSet::getSquelch() const
{
