...
void CDummyRepeaterSlowDataEncoder::getData(unsigned char* data)
{
	wxASSERT(data != NULL);
...
void CDummyRepeaterSlowDataEncoder::reset()
{
	m_initial.clear();
	m_body.clear();
...
void CDummyRepeaterSlowDataEncoder::setHeaderData(const CHeaderData& header)
{
...
void CDummyRepeaterSlowDataEncoder::setMessageData(const wxString& message)
{
	if (message.IsEmpty())
		return;
...
void CDummyRepeaterSlowDataEncoder::setCodeSquelch(unsigned char value)
{
...
void CDummyRepeaterSlowDataEncoder::buildData()
{
