...
extern int	NODEAPI	node_puthdr(const unsigned char *, int);
extern int	NODEAPI	node_getdta(unsigned char *, int);
extern int	NODEAPI	node_putdta(const unsigned char *, int);
...
extern int	NODEAPI	node_puteeprom(const unsigned char *, int);
