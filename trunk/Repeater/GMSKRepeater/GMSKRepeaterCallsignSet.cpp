...
BEGIN_EVENT_TABLE(CGMSKRepeaterCallsignSet, wxPanel)
	EVT_CHOICE(CHOICE_MODE, CGMSKRepeaterCallsignSet::onMode)
END_EVENT_TABLE()


CGMSKRepeaterCallsignSet::CGMSKRepeaterCallsignSet(wxWindow* parent, int id, const wxString& title, const wxString& callsign, const wxString& gateway, DSTAR_MODE mode, ACK_TYPE ack, bool restriction, bool rpt1Validation, bool dtmfBlanking) :
wxPanel(parent, id),
m_title(title),
m_callsign(NULL),
m_gateway(NULL),
...
CGMSKRepeaterCallsignSet::~CGMSKRepeaterCallsignSet()
{
}

bool CGMSKRepeaterCallsignSet::Validate()
{
...
wxString CGMSKRepeaterCallsignSet::getCallsign() const
{
...
wxString CGMSKRepeaterCallsignSet::getGateway() const
{
...
DSTAR_MODE CGMSKRepeaterCallsignSet::getMode() const
{
...
ACK_TYPE CGMSKRepeaterCallsignSet::getAck() const
{
...
bool CGMSKRepeaterCallsignSet::getRestriction() const
{
...
void CGMSKRepeaterCallsignSet::onMode(wxCommandEvent &event)
{
...
bool CGMSKRepeaterCallsignSet::getRPT1Validation() const
{
...
bool CGMSKRepeaterCallsignSet::getDTMFBlanking() const
{
