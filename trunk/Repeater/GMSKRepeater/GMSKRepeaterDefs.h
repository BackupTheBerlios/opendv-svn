...
#ifndef	GMSKRepeaterDefs_H
#define	GMSKRepeaterDefs_H

#include <wx/wx.h>

const wxString APPLICATION_NAME    = wxT("GMSK Repeater");
const wxString LOG_BASE_NAME       = wxT("GMSKRepeater");

#if !defined(__WINDOWS__)
const wxString CONFIG_FILE_NAME = wxT("gmskrepeater");
