...
CSplitRepeaterCallsignSet::CSplitRepeaterCallsignSet(wxWindow* parent, int id, const wxString& title, const wxString& callsign, const wxString& gateway, DSTAR_MODE mode, ACK_TYPE ack, bool restriction, bool rpt1Validation, bool dtmfBlanking) :
wxPanel(parent, id),
m_title(title),
m_callsign(NULL),
m_gateway(NULL),
...
bool CSplitRepeaterCallsignSet::getDTMFBlanking() const
{
