...
CSplitRepeaterLogger::CSplitRepeaterLogger() :
wxLog()
{
}
...
void CSplitRepeaterLogger::DoLog(wxLogLevel level, const wxChar* msg, time_t timestamp)
{
	wxASSERT(msg != NULL);
...
void CSplitRepeaterLogger::DoLogString(const wxChar* msg, time_t)
{
	wxASSERT(msg != NULL);
