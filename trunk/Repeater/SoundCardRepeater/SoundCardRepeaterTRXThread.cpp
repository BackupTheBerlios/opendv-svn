...
void CSoundCardRepeaterTRXThread::start()
{
	Create();
...
void* CSoundCardRepeaterTRXThread::Entry()
{
...
void CSoundCardRepeaterTRXThread::wait()
{
	Wait();
}
...
void CSoundCardRepeaterTRXThread::setCallsign(const wxString& callsign, const wxString& gateway, DSTAR_MODE mode, ACK_TYPE ack, bool restriction, bool rpt1Validation)
{
...
void CSoundCardRepeaterTRXThread::setWhiteList(CCallsignList* list)
{
	wxASSERT(list != NULL);
