...
class CSoundCardRepeaterApp : public wxApp {

public:
	CSoundCardRepeaterApp();
	virtual ~CSoundCardRepeaterApp();
	...
	virtual CSoundCardRepeaterStatusData* getStatus() const;
	...
	virtual void getRadio(wxString& readDevice, wxString& writeDevice, wxFloat32& rxLevel, wxFloat32& txLevel, SQUELCH_MODE& squelchMode, wxFloat32& squelchLevel, bool& rxInvert, bool& txInvert) const;
	virtual void setRadio(const wxString& readDevice, const wxString& writeDevice, wxFloat32 rxLevel, wxFloat32 txLevel, SQUELCH_MODE squelchMode, wxFloat32 squelchLevel, bool rxInvert, bool txInvert);

	virtual void getController(wxString& type, unsigned int& config, int& pttDelay, bool& pttInvert) const;
	virtual void setController(const wxString& type, unsigned int config, int pttDelay, bool pttInvert);

	virtual void getTimes(unsigned int& timeout, unsigned int& ackTime, unsigned int& hangTime) const;
	virtual void setTimes(unsigned int timeout, unsigned int ackTime, unsigned int hangTimer);
...
DECLARE_APP(CSoundCardRepeaterApp)
