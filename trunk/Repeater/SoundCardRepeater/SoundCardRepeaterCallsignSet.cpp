...
BEGIN_EVENT_TABLE(CSoundCardRepeaterCallsignSet, wxPanel)
	EVT_CHOICE(CHOICE_MODE, CSoundCardRepeaterCallsignSet::onMode)
END_EVENT_TABLE()
...
CSoundCardRepeaterCallsignSet::~CSoundCardRepeaterCallsignSet()
{
}

bool CSoundCardRepeaterCallsignSet::Validate()
{
...
wxString CSoundCardRepeaterCallsignSet::getCallsign() const
{
...
wxString CSoundCardRepeaterCallsignSet::getGateway() const
{
...
DSTAR_MODE CSoundCardRepeaterCallsignSet::getMode() const
{
...
ACK_TYPE CSoundCardRepeaterCallsignSet::getAck() const
{
...
bool CSoundCardRepeaterCallsignSet::getRestriction() const
{
...
void CSoundCardRepeaterCallsignSet::onMode(wxCommandEvent &event)
{
