...
#ifndef	DStarClientDefs_H
#define	DStarClientDefs_H
...
const wxString APPLICATION_NAME = wxT("D-Star Client");

const wxString LOG_FILE_NAME    = wxT("DStarClient");

const wxString CQCQCQ = wxT("CQCQCQ");
const wxString DIRECT = wxT("DIRECT  ");
const wxString UNUSED = wxT("<unused>");

const int USER_AUDIO_ID  = 1;
const int RADIO_AUDIO_ID = 2;
