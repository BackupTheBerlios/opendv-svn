...
#ifndef	DStarClientApp_H
#define	DStarClientApp_H
...
class CDStarClientApp : public wxApp {

public:
	CDStarClientApp();
	virtual ~CDStarClientApp();
...
private:
	CDStarClientFrame*  m_frame;
	CDStarClientThread* m_thread;

	void createThread();
};

DECLARE_APP(CDStarClientApp)
