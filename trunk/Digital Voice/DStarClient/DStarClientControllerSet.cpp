...
CDStarClientControllerSet::CDStarClientControllerSet(wxWindow* parent, int id, const wxString& title, const wxString& type, bool ptt, unsigned int delay, bool invert) :
wxPanel(parent, id),
m_title(title),
m_type(NULL),
m_ptt(NULL),
...
CDStarClientControllerSet::~CDStarClientControllerSet()
{
}

bool CDStarClientControllerSet::Validate()
{
...
wxString CDStarClientControllerSet::getType() const
{
...
bool CDStarClientControllerSet::getPTT() const
{
...
unsigned int CDStarClientControllerSet::getDelay() const
{
...
bool CDStarClientControllerSet::getInvert() const
{
