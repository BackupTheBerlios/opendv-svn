...
#include "DStarClientFrame.h"
#include "DStarClientApp.h"
...
BEGIN_EVENT_TABLE(CDStarClientFrame, wxFrame)
	EVT_MENU(wxID_OPEN, CDStarClientFrame::onOpen)
	EVT_MENU(Menu_File_Recording, CDStarClientFrame::onRecording)
	EVT_MENU(wxID_EXIT, CDStarClientFrame::onQuit)
	EVT_MENU(Menu_Edit_Preferences, CDStarClientFrame::onPreferences)
	EVT_MENU(wxID_ABOUT, CDStarClientFrame::onAbout)

	EVT_CLOSE(CDStarClientFrame::onClose)

	EVT_TEXT_ENTER(Combo_Your, CDStarClientFrame::onYour)
	EVT_COMBOBOX(Combo_Your, CDStarClientFrame::onYour)

	EVT_TEXT_ENTER(Combo_Rpt1, CDStarClientFrame::onRpt1)
	EVT_COMBOBOX(Combo_Rpt1, CDStarClientFrame::onRpt1)

	EVT_TEXT_ENTER(Combo_Rpt2, CDStarClientFrame::onRpt2)
	EVT_COMBOBOX(Combo_Rpt2, CDStarClientFrame::onRpt2)

	EVT_TOGGLEBUTTON(Button_Transmit, CDStarClientFrame::onTransmit)

	EVT_BUTTON(Button_OneTouchReply, CDStarClientFrame::onOneTouchReply)

	EVT_CUSTOM(MESSAGE_EVENT, wxID_ANY, CDStarClientFrame::onMessage)
	EVT_CUSTOM(HEADER_EVENT,  wxID_ANY, CDStarClientFrame::onHeader)
	EVT_CUSTOM(ERROR_EVENT,   wxID_ANY, CDStarClientFrame::onError)
	EVT_CUSTOM(BUSY_EVENT,    wxID_ANY, CDStarClientFrame::onBusy)
END_EVENT_TABLE()

CDStarClientFrame::CDStarClientFrame(const wxString& title) :
...
CDStarClientFrame::~CDStarClientFrame()
{
}

wxMenuBar* CDStarClientFrame::createMenuBar()
{
...
void CDStarClientFrame::showMessage(CMessageData* message)
{
...
void CDStarClientFrame::showHeader(CHeaderData* header)
{
...
void CDStarClientFrame::showBusy(CBusyData* busy)
{
	wxASSERT(busy != NULL);
...
void CDStarClientFrame::error(const wxString& error)
{
...
void CDStarClientFrame::onOpen(wxCommandEvent& event)
{
...
void CDStarClientFrame::onRecording(wxCommandEvent& event)
{
...
void CDStarClientFrame::onQuit(wxCommandEvent& event)
{
	Close(false);
}

void CDStarClientFrame::onClose(wxCloseEvent& event)
{
	if (!event.CanVeto()) {
		saveCalls();
		Destroy();
	...
	int reply = ::wxMessageBox(_("Do you want to exit D-Star Client"), _("Exit D-Star Client"), wxOK | wxCANCEL | wxICON_QUESTION);
	switch (reply) {
		case wxOK:
			saveCalls();
			Destroy();
...
void CDStarClientFrame::onPreferences(wxCommandEvent& event)
{
	...
	CDStarClientPreferences dialog(this, -1, oldCallsign1, oldCallsign2, oldAudioReadDevice, oldAudioWriteDevice,
...
void CDStarClientFrame::onAbout(wxCommandEvent& event)
{
...
void CDStarClientFrame::onYour(wxCommandEvent& event)
{
...
bool CDStarClientFrame::processYour(wxString& your)
{
	your.MakeUpper();
...
void CDStarClientFrame::onRpt1(wxCommandEvent& event)
{
...
bool CDStarClientFrame::processRpt1(wxString& rpt1)
{
...
void CDStarClientFrame::onRpt2(wxCommandEvent& event)
{
...
bool CDStarClientFrame::processRpt2(wxString& rpt2)
{
...
void CDStarClientFrame::onTransmit(wxCommandEvent& event)
{
...
void CDStarClientFrame::onOneTouchReply(wxCommandEvent& event)
{
...
void CDStarClientFrame::onMessage(wxEvent& event)
{
...
void CDStarClientFrame::onHeader(wxEvent& event)
{
...
void CDStarClientFrame::onBusy(wxEvent& event)
{
...
void CDStarClientFrame::onError(wxEvent& event)
{
...
void CDStarClientFrame::saveCalls() const
{
