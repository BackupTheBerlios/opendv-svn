...
CDStarClientApp::CDStarClientApp() :
wxApp(),
m_frame(NULL),
m_thread(NULL)
{
...
bool CDStarClientApp::OnInit()
{
	...
	m_frame = new CDStarClientFrame(APPLICATION_NAME + wxT(" - ") + VERSION);
	m_frame->Show();
...
void CDStarClientApp::OnAssertFailure(const wxChar* file, int line, const wxChar* func, const wxChar* cond, const wxChar* msg)
{
	wxLogFatalError(wxT("Assertion failed on line %d in file %s and function %s: %s %s"), line, file, func, cond, msg);
}
#endif

void CDStarClientApp::showMessage(CMessageData* message) const
{
...
void CDStarClientApp::showHeader(CHeaderData* header) const
{
...
void CDStarClientApp::showBusy(CBusyData* busy) const
{
	wxASSERT(busy != NULL);
...
void CDStarClientApp::error(const wxString& text) const
{
	m_frame->error(text);
}

void CDStarClientApp::setReader(CWAVFileReader* reader)
{
	return m_thread->setReader(reader);
}

void CDStarClientApp::setYour(const wxString& your)
{
	m_thread->setYour(your);
}

void CDStarClientApp::setRpt1(const wxString& rpt1)
{
	m_thread->setRpt1(rpt1);
}

void CDStarClientApp::setRpt2(const wxString& rpt2)
{
	m_thread->setRpt2(rpt2);
}

bool CDStarClientApp::setTransmit(bool on)
{
	return m_thread->setTransmit(on);
}

void CDStarClientApp::setRecording(bool recording)
{
	m_thread->setRecording(recording);
}

void CDStarClientApp::getCallsign(wxString& callsign1, wxString& callsign2) const
{
...
void CDStarClientApp::setCallsign(const wxString& callsign1, const wxString& callsign2) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::getMessage(wxString& message) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::setMessage(const wxString& message) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::getController(wxString& type, bool& pttEnable, unsigned int& txDelay, bool& txInvert) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::setController(const wxString& type, bool pttEnable, unsigned int txDelay, bool txInvert) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::getRadioSoundcard(wxString& readDevice, wxString& writeDevice) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::setRadioSoundcard(const wxString& readDevice, const wxString& writeDevice) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::getInversion(bool& rxInvert, bool& txInvert) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::setInversion(bool rxInvert, bool txInvert) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::getAudioSoundcard(wxString& readDevice, wxString& writeDevice) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::setAudioSoundcard(const wxString& readDevice, const wxString& writeDevice) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::getDVDongle(wxString& device) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::setDVDongle(const wxString& device) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::getYourCalls(wxString& call, wxSortedArrayString& list) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::setYourCalls(const wxString& call, const wxSortedArrayString& list) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::getRpt1Calls(wxString& call, wxSortedArrayString& list) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::setRpt1Calls(const wxString& call, const wxSortedArrayString& list) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::getRpt2Calls(wxString& call, wxSortedArrayString& list) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::setRpt2Calls(const wxString& call, const wxSortedArrayString& list) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::getBleep(bool& on) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::setBleep(bool on) const
{
	wxConfigBase* profile = new wxConfig(APPLICATION_NAME);
	wxASSERT(profile != NULL);
...
void CDStarClientApp::createThread()
{
	m_thread = new CDStarClientThread;
	m_thread->Create();
	m_thread->Run();
