...
#ifndef	DStarClientFrame_H
#define	DStarClientFrame_H
...
class CDStarClientFrame : public wxFrame {
public:
	CDStarClientFrame(const wxString& title = wxEmptyString);
	virtual ~CDStarClientFrame();
