...
public:
	CDummyRepeaterMessageEvent(CDummyRepeaterMessageData* message, wxEventType type, int id = 0);
	virtual ~CDummyRepeaterMessageEvent();

	virtual CDummyRepeaterMessageData* getMessageData() const;
...
private:
	CDummyRepeaterMessageData* m_message;
};
