...
#ifndef	DVAPClientApp_H
#define	DVAPClientApp_H
...
class CDVAPClientApp : public wxApp {

public:
	CDVAPClientApp();
	virtual ~CDVAPClientApp();
...
private:
	CDVAPClientFrame*  m_frame;
	CDVAPClientThread* m_thread;

	void createThread();
};

DECLARE_APP(CDVAPClientApp)
