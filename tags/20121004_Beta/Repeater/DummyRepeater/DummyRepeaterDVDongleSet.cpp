...
CDummyRepeaterDVDongleSet::CDummyRepeaterDVDongleSet(wxWindow* parent, int id, const wxString& title, const wxString& device) :
wxPanel(parent, id),
m_title(title),
m_device(NULL)
{
...
CDummyRepeaterDVDongleSet::~CDummyRepeaterDVDongleSet()
{
}

bool CDummyRepeaterDVDongleSet::Validate()
{
...
wxString CDummyRepeaterDVDongleSet::getDevice() const
{
