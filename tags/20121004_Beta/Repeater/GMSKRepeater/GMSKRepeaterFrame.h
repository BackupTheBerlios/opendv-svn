...
#ifndef	GMSKRepeaterFrame_H
#define	GMSKRepeaterFrame_H

#include "GMSKRepeaterDefs.h"

#include <wx/wx.h>

class CGMSKRepeaterFrame : public wxFrame {
public:
	CGMSKRepeaterFrame(const wxString& title, const wxPoint& position, bool gui);
	virtual ~CGMSKRepeaterFrame();
