...
CDVRPTRRepeaterControllerSet::CDVRPTRRepeaterControllerSet(wxWindow* parent, int id, const wxString& title, const wxString& type, unsigned int time) :
wxPanel(parent, id),
m_title(title),
m_type(NULL),
m_time(NULL)
...
CDVRPTRRepeaterControllerSet::~CDVRPTRRepeaterControllerSet()
{
}

bool CDVRPTRRepeaterControllerSet::Validate()
{
...
wxString CDVRPTRRepeaterControllerSet::getType() const
{
...
unsigned int CDVRPTRRepeaterControllerSet::getTime() const
{
