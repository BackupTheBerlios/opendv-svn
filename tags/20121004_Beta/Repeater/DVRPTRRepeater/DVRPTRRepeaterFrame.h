...
#ifndef	DVRPTRRepeaterFrame_H
#define	DVRPTRRepeaterFrame_H

#include "DVRPTRRepeaterDefs.h"

#include <wx/wx.h>

class CDVRPTRRepeaterFrame : public wxFrame {
public:
	CDVRPTRRepeaterFrame(const wxString& title, const wxPoint& position, bool gui);
	virtual ~CDVRPTRRepeaterFrame();
