...
#ifndef	DVRPTRRepeaterCallsignSet_H
#define	DVRPTRRepeaterCallsignSet_H
...
class CDVRPTRRepeaterCallsignSet : public wxPanel {
public:
	CDVRPTRRepeaterCallsignSet(wxWindow* parent, int id, const wxString& title, const wxString& callsign, const wxString& gateway, DSTAR_MODE mode, ACK_TYPE ack, bool restriction, bool rpt1Validation);
	virtual ~CDVRPTRRepeaterCallsignSet();
