...
#ifndef	SoundCardRepeaterFrame_H
#define	SoundCardRepeaterFrame_H

#include "SoundCardRepeaterDefs.h"

#include <wx/wx.h>

class CSoundCardRepeaterFrame : public wxFrame {
public:
	CSoundCardRepeaterFrame(const wxString& title, const wxPoint& position, bool gui);
	virtual ~CSoundCardRepeaterFrame();
