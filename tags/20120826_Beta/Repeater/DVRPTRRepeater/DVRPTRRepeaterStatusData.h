...
#ifndef	DVRPTRRepeaterStatusData_H
#define	DVRPTRRepeaterStatusData_H
...
class CDVRPTRRepeaterStatusData {
public:
	CDVRPTRRepeaterStatusData(const wxString& myCall1, const wxString& myCall2, const wxString& yourCall,
