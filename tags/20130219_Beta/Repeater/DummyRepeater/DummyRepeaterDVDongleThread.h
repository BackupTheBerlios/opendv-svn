...
#ifndef	DummyRepeaterDVDongleThread_H
#define	DummyRepeaterDVDongleThread_H
...
class CDummyRepeaterDVDongleThread : public wxThread {
public:
	CDummyRepeaterDVDongleThread(CDVDongleController* dongle, CRingBuffer<wxFloat32>* decodeAudio, CRingBuffer<unsigned char>* decodeData, CRingBuffer<wxFloat32>* encodeAudio = NULL, CRingBuffer<unsigned char>* encodeData = NULL);
	virtual ~CDummyRepeaterDVDongleThread();
